...
class AgregarProveedor():
    ...
    def create_widgets(self):
        ...
        l1 = Formulario_empresa(menu1)
        l2 = Formulario_domicilio(menu2)
        l3 = Formulario_datos_bancarios(menu3)
        l4 = Formulario_contacto(menu4)
        l5 = Formulario_observaciones(menu5)
