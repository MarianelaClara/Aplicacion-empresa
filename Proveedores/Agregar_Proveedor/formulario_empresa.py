...
class Formulario_empresa():
    ...
    def create_widgets(self):
        ...
        self.id_fiscal.place(relx = 0.6, rely = 0.07, relwidth = 0.3, relheight = 0.15)

        ttk.Label(self.frame, text = "Nombre fiscal:").place(relx = 0.02, rely = 0.425, relheight = 0.15)
        self.nombre_fiscal = ttk.Entry(self.frame)
        self.nombre_fiscal.place(relx = 0.26, rely = 0.425, relwidth = 0.3, relheight = 0.15)
        ...
        self.nombre_comercial.place(relx = 0.31, rely = 0.78, relwidth = 0.3, relheight = 0.15)
